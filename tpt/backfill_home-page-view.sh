...
TABLE="tpt-data-warehouse-prod:dev_outbox.home_page_view_backfill_$YEAR$MONTH$DAY"
GCS="gs://tpt_data_sci_dev/resources-recommendations/home-page-view/backfill/$YEAR/$MONTH/$DAY/$RUN/*.json"
GCS_ERROR="gs://tpt_data_sci_dev/resources-recommendations-errors/"
SQL="$(jinja2 --strict -D dt=$YEAR-$MONTH-$DAY -D backfill=yes sql/home_page_view.tpl.sql)"
